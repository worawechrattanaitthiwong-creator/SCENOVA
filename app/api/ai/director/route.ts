...
function analyzerPrompt(input: z.infer<typeof requestSchema>) {
  ...
  return [
    ...
    "ตัวละคร: ยึด Cast ที่มีชื่ออยู่แล้วเป็นข้อเท็จจริง แต่ถ้ามีช่อง Cast ว่างและเนื้อเรื่อง/Action ระบุตัวละครชัดเจน ให้สกัดชื่อหรือคำเรียกตัวละครจากเนื้อเรื่องเพื่อเติมช่องว่างได้ ห้ามสร้างบุคคลที่เรื่องไม่ได้กล่าวถึง",
