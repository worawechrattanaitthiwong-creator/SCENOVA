...
export default function StudioModelPickerPolish() {
  ...
  const styles = useMemo(() => `
    ...
    .sc-ai-select-copy strong{font-size:11.5px;line-height:1.2}.sc-ai-select-copy small{margin-top:1px;color:var(--muted);font-size:7.5px}
    .sc-ai-select-chevron{color:var(--accent);font-size:18px;line-height:1;transform:translateY(-1px)}
    ...
    .sc-brand-icon{width:25px;height:25px;flex:0 0 25px;display:grid;place-items:center;border-radius:9px;overflow:hidden;background:color-mix(in srgb,var(--surface3) 82%,black 18%);color:#f7f4ff;box-shadow:inset 0 0 0 1px rgba(255,255,255,.07)}
    .sc-brand-icon.is-large{width:28px;height:28px;flex-basis:28px;border-radius:8px}.sc-brand-icon svg{width:100%;height:100%;display:block}
    ...
    .sc-ai-status-dot{width:7px;height:7px;flex:0 0 7px;border-radius:50%;box-shadow:0 0 0 3px color-mix(in srgb,currentColor 10%,transparent),0 0 10px currentColor}
    ...
    .sc-ai-model-field [data-sc-model-capabilities]{display:flex!important;flex-wrap:nowrap!important;gap:4px!important;margin-top:4px!important;overflow:hidden!important}
    .sc-ai-model-field [data-sc-model-capabilities]>span,.sc-ai-model-field [data-sc-model-capabilities]>a{display:inline-flex!important;align-items:center!important;min-width:0!important;max-width:52%!important;min-height:22px!important;padding:3px 7px!important;overflow:hidden!important;border:1px solid color-mix(in srgb,var(--accent) 20%,var(--border))!important;border-radius:999px!important;background:color-mix(in srgb,var(--surface3) 92%,var(--accent) 8%)!important;color:var(--text)!important;font-size:8px!important;line-height:1.15!important;text-decoration:none!important;text-overflow:ellipsis!important;white-space:nowrap!important}
